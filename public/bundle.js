...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: inputName }), document.getElementById('app'));
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { ref: 'name', type: 'text', placeholder: 'Enter name', autofocus: true }),
